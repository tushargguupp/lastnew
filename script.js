// Initialize all dropdowns after the DOM has fully loaded
document.addEventListener('DOMContentLoaded', function () {
    // Select all elements with the 'dropdown-toggle' class
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const elementsToAnimate = document.querySelectorAll('.card, .more-card');
    ...
    elementsToAnimate.forEach(element => {
        observer.observe(element); // Attach observer to each element
    });
});
